...
- PostgreSQL, TimescaleDB, Redis, EMQX, Keycloak, MQTT, and HTTP contracts remain portable.
...
See the [AWS host](aws-temporary-deployment.md), [campus host](campus-server-deployment.md), [migration architecture](migration-architecture.md), [ADR-014](../decisions/ADR-014-aws-temporary-host.md), [ADR-015](../decisions/ADR-015-campus-final-host.md), and [ADR-016](../decisions/ADR-016-s3-compatible-storage.md).
